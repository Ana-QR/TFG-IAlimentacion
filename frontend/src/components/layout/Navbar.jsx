...
const Navbar = ({ onToggleSidebar, isOpen }) => {
  ...
  return (
    <header className="bg-primary shadow-sm relative z-30">
      <div className="max-w-5xl mx-auto px-4 py-4 grid grid-cols-3 items-center relative">
        {/* Izquierda: botón sidebar (solo escritorio) */}
        <div className="flex items-center">
          {!isRegistroPage && (
            <button
              onClick={onToggleSidebar}
              className="p-2 rounded text-background hover:bg-white/10 transition hidden md:block"
